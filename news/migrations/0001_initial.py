...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('news_article', (
            ...
            ('event_location', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
        ))
    ...
    models = {
        ...
        'news.article': {
            ...
            'event_location': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
